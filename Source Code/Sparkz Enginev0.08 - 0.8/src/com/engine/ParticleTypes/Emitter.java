...
public class Emitter extends Molecule {
    ...
    public Emitter(double _x, double _y, double _radius, double speed, double direction) {
        super(_x, _y, _radius, speed, direction, 0);
    }

    private void emitAtPoint() {ParticleModes.fireworksMode(x, y, fireworksWind, fireworksSpeedVal, fireworksAmount);}
    public void render() {
