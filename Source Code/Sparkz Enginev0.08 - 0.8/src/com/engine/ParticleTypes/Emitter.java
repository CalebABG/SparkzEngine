...
public class Emitter extends Molecule {
    ...
    private void emitAtPoint() {
        ParticleModes.fireworksMode(x, y, rfWind,(int) (fireworksSpeedVal), fireworksAmount);
    }
    ...
    public void update () {boundsCheck(); emitAtPoint(); if (life == 0) {EmitterArray.remove(this);} life -= 1;}
}
