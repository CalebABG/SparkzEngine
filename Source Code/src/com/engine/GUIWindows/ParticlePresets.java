...
public class ParticlePresets {
    ...
    private ParticlePresets() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            {if (e.getSource() == btnNewButton) setPresetColors(propaneColor());}});
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button) setPresetColors(maritime());}});
        frame.add(button);
        ...
        button_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_1) setPresetColors(dayAndNight());}});
        frame.add(button_1);
        ...
        button_2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_2) setPresetColors(plantLife());}});
        frame.add(button_2);
        ...
        button_3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_3) setPresetColors(fancyCoffee());}});
        frame.add(button_3);
        ...
        button_4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_4) setPresetColors(cinnamonSpice());}});
        frame.add(button_4);
        ...
        button_5.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_5) setPresetColors(pastels());}});
        frame.add(button_5);
        ...
        button_6.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_6) setPresetColors(exoticBerries());}});
        frame.add(button_6);
        ...
        button_7.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_7) setPresetColors(citrus());}});
        frame.add(button_7);
        ...
        button_8.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_8) setPresetColors(candy());}});
        frame.add(button_8);
        ...
        button_9.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_9) setPresetColors(oceanBlues());}});
        frame.add(button_9);
        ...
        button_10.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_10) setPresetColors(hazyday());}});
        frame.add(button_10);
        ...
        button_11.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_11) setPresetColors(retro());}});
        frame.add(button_11);
        ...
        button_12.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_12) setPresetColors(shadowslate());}});
        frame.add(button_12);
        ...
        button_13.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {if (e.getSource() == button_13) setPresetColors(onyximpact());}});
        frame.add(button_13);
