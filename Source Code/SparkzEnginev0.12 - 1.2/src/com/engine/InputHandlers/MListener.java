...
public class MListener extends MouseAdapter{
    public void mousePressed(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1) LEFT_MOUSE_IS_DOWN.setValue(true);
        else if (e.getButton() == MouseEvent.BUTTON3) RIGHT_MOUSE_IS_DOWN.setValue(true);
    }

    public void mouseReleased(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1) LEFT_MOUSE_IS_DOWN.setValue(false);
        else if (e.getButton() == MouseEvent.BUTTON3) RIGHT_MOUSE_IS_DOWN.setValue(false);
