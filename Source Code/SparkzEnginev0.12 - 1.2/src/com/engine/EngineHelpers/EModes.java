...
public interface EModes {
    ...
    enum ENGINE_MODES {
        ...
        ENGINE_MODES(int value) {this.value = value;}
    ...
    enum PARTICLE_TYPES {
        ...
        PARTICLE_TYPES(int value) {this.value = value;}
        public int getValue() {return value;}
        public String getValueS(){return value+"";}
    ...
    enum GRAVITATION_MODES {
        ...
        GRAVITATION_MODES(int value) {this.value = value;}
        public int getValue() {return value;}
        public String getValueS(){return value+"";}
    ...
    enum MOLECULE_RENDER_MODES {
        ...
        MOLECULE_RENDER_MODES(int value) {this.value = value;}
        public int getValue() {return value;}
        public String getValueS(){return value+"";}
